  ...
  useEffect(() => {
    ...
    gsap.to(ref.current, {
      ...
      scrollTrigger: {
        ...
        end: 'bottom top', //ends animation when section leaves viewport
      ...
      >
        ...
        <div className='relative flex h-full flex-col justify-end gap-2 md:flex-col-reverse md:justify-normal'>
          ...
          <div className=' md:flex '>
            ...
            <div className='md:absolute md:top-[45%] md:right-[-2%] mx-10 md:ml-auto md:mr-16 max-md:my-12 '>
              <div className='md:absolute md:top-[-12.5vh] mb-4 md:mb-20 '>
